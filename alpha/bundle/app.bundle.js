...
;// CONCATENATED MODULE: ./src/builders/SuFile.ts

var SuFile = /** @class */ (function () {
    function SuFile(pathname) {
        var _this = this;
        this.storage = {
            /**
            ...
            read: function () {
                if (native_Constants.isAndroid) {
                    return android.SuFile(_this.pathname).storage().read();
                }
                else {
                    return "";
                }
        ...
        this.system = {
            ...
            read: function () {
                if (native_Constants.isAndroid) {
                    return android.SuFile(_this.pathname).system().read();
                }
                else {
                    return "";
                }
            ...
            list: function () {
                if (native_Constants.isAndroid) {
                    return android.SuFile(_this.pathname).system().list();
                }
                else {
                    return "";
                }
            ...
            exists: function () {
                if (native_Constants.isAndroid) {
                    return android.SuFile(_this.pathname).system().exists();
                }
                else {
                    return false;
                }
            ...
            createNewFile: function () {
                if (native_Constants.isAndroid) {
                    return android.SuFile(_this.pathname).system().createNewFile();
                }
                else {
                    return false;
                }
            ...
            delete: function () {
                if (native_Constants.isAndroid) {
                    return android.SuFile(_this.pathname).system().delete();
                }
                else {
                    return false;
                }
            ...
            deleteRecursive: function () {
                if (native_Constants.isAndroid) {
                    return android.SuFile(_this.pathname).system().deleteRecursive();
                }
                else {
                    return;
                }
...
/* harmony default export */ const builders_SuFile = (SuFile);
...
;// CONCATENATED MODULE: ./src/components/icons/DeleteIcon.jsx
...
;// CONCATENATED MODULE: ./src/builders/Toast.ts
...
/* harmony default export */ const builders_Toast = (Toast);
...
var SharedPreferences = /** @class */ (function () {
    ...
    SharedPreferences.prototype.getPref = function (key) {
        if (native_Constants.isAndroid) {
            var get = android.getSharedPreferences().getPref(key);
...
var DeviceModule = /** @class */ (function (_super) {
    ...
    function DeviceModule(props) {
        ...
        _this.componentDidMount = function () {
            ...
            var readProps = new builders_SuFile("/data/adb/modules/".concat(module, "/module.prop")).system.read();
            _this.setState({
                props: cjs_default().parseToProperties(readProps),
            });
            var disable = new builders_SuFile("/data/adb/modules/".concat(module, "/disable"));
            if (disable.system.exists()) {
                _this.setState({ isEnabled: false });
            }
            var remove = new builders_SuFile("/data/adb/modules/".concat(module, "/remove"));
        ...
        _this.render = function () {
            ...
            return ((0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)(components_Gesture, DeviceModule_assign({ event: "hold", callback: _this.showDialog }, { children: (0,jsx_runtime.jsx)(react_onsenui.Card, DeviceModule_assign({ id: id, 
                                //@ts-ignore
                                style: { marginTop: "4px", marginBottom: "4px" } }, { children: (0,jsx_runtime.jsxs)("item-card-wrapper", { children: [(0,jsx_runtime.jsx)("item-title", DeviceModule_assign({ className: "title" }, { children: (0,jsx_runtime.jsxs)("item-module-name", { children: [(0,jsx_runtime.jsx)("item-name", { children: name }), (0,jsx_runtime.jsx)("item-switch", { children: (0,jsx_runtime.jsx)(react_onsenui.Switch, { checked: _this.state.isEnabled, disabled: _this.state.isSwitchDisabled, onChange: function (e) {
                                                            ...
                                                            } }) }), " "] }) })), (0,jsx_runtime.jsxs)("div", DeviceModule_assign({ className: "content" }, { children: [(0,jsx_runtime.jsxs)("item-version-author", { children: [version, " / ", author] }), (0,jsx_runtime.jsx)("item-description", { children: description })] }))] }) }), id) })), (0,jsx_runtime.jsx)(react_onsenui.Dialog, DeviceModule_assign({ visible: _this.state.dialogShown, cancelable: true, onDialogCancel: _this.hideDialog }, { children: (0,jsx_runtime.jsx)(react_onsenui.List, DeviceModule_assign({ style: { margin: "20px" } }, { children: (function () {
                                    if (isSwitchDisabled) {
                                        return ((0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: (0,jsx_runtime.jsxs)(react_onsenui.ListItem, DeviceModule_assign({ onClick: function () {
                                                    var remove = new builders_SuFile("/data/adb/modules/".concat(module, "/remove"));
                                                    if (remove.system.exists()) {
                                                        if (remove.system.delete()) {
                                                            ...
                                                            _this.log.e("Failed to recover ".concat(module));
                                                        }
                                                    }
                                                    else {
                                                        _this.log.e("This remove file don't exists for ".concat(module));
                                                    }
                                                } }, { children: [(0,jsx_runtime.jsx)("div", DeviceModule_assign({ className: "left" }, { children: (0,jsx_runtime.jsx)(icons_TimeIcon, { size: "24" }) })), (0,jsx_runtime.jsx)("div", DeviceModule_assign({ className: "center" }, { children: "Recover module" }))] })) }));
                                    }
                                    else {
                                        return ((0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: (0,jsx_runtime.jsxs)(react_onsenui.ListItem, DeviceModule_assign({ onClick: function () {
                                                    var file = new builders_SuFile("/data/adb/modules/".concat(module, "/remove"));
                                                    new builders_AlertBuilder()
                                                        .setTitle("Delete ".concat(name))
                                                        .setMessage("Are you sure to delete the module forever?")
                                                        .setPositiveButton("Yes", function () {
                                                        if (file.system.createNewFile()) {
                                                            _this.setState({ isSwitchDisabled: true });
                                                            builders_Toast.makeText("Module get removed on next reboot", builders_Toast.LENGTH_LONG).show();
                                                        }
                                                        else {
                                                            _this.setState({ isSwitchDisabled: false });
                                                            builders_Toast.makeText("Failed to add reomve to ".concat(module, " module"), builders_Toast.LENGTH_LONG).show();
                                                        }
                                                    })
                                                        .showAlert();
                                                } }, { children: [(0,jsx_runtime.jsx)("div", DeviceModule_assign({ className: "left" }, { children: (0,jsx_runtime.jsx)(icons_DeleteIcon, { size: "24" }) })), (0,jsx_runtime.jsx)("div", DeviceModule_assign({ className: "center" }, { children: "Remove module" }))] })) }));
                                    }
                                })() })) }))] }) }));
        };
        _this.state = {
...
var DeviceModuleFragment = /** @class */ (function (_super) {
    ...
    function DeviceModuleFragment(props) {
        var _this = _super.call(this, props) || this;
        _this.componentDidMount = function () {
            _this.setState({ modules: android.SuFile("/data/adb/modules").system().list().split(",") });
        };
        _this.render = function () {
...
var PackageManager = /** @class */ (function () {
    ...
    Object.defineProperty(PackageManager, "getMagiskVersionCode", {
        get: function () {
            if (native_Constants.isAndroid) {
                return parseInt(builders_ShellBuilder.cmd("su -V").result());
            }
            else {
                return 0;
            }
    ...
    PackageManager.parseMagisk = function (version) {
                                        ...
                                        esm["default"].notification.alert("The option will be available in the future");
                                            ...
                                            if (minMagisk != ( false || undefined)) {
                                                return ((0,jsx_runtime.jsxs)("tr", { children: [(0,jsx_runtime.jsx)("td", ViewModuleActivity_assign({ style: {
                                                                ...
                                                                color: native_Constants.isAndroid
                                                                    ? native_PackageManager.parseMagisk(minMagisk) > native_PackageManager.getMagiskVersionCode
                                                                        ? "red"
                                                                        : ""
                                                                    : "",
                                                            } }, { children: minMagisk }))] }));
        ...
        _this.render = function () {
            ...
            return ((0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: (0,jsx_runtime.jsx)("div", ExploreModule_assign({ ref: _this.openReadmeFromParam, onClick: function () {
                        ...
                        style: { display: _display, marginTop: "4px", marginBottom: "4px" } }, { children: (0,jsx_runtime.jsxs)("item-card-wrapper", { children: [(0,jsx_runtime.jsxs)("item-title", ExploreModule_assign({ className: "title" }, { children: [(function () {
                                            if (isLQModule) {
                                                ...
                                                return null;
                                        ...
                                        })(), (0,jsx_runtime.jsx)("item-module-name", ExploreModule_assign({ ref: _this.cardName }, { children: (0,jsx_runtime.jsxs)("span", ExploreModule_assign({ style: {
                                                    fontSize: "large",
                                                    overflow: "hidden",
                                                    textAlign: "start",
                                                    ...
                                                    })()] })) }))] })), (0,jsx_runtime.jsxs)("div", ExploreModule_assign({ className: "content" }, { children: [(0,jsx_runtime.jsxs)("item-version-author", ExploreModule_assign({ style: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [736], () => (__webpack_require__(9414)))
